document.addEventListener('DOMContentLoaded', function () {
    ...
    if (obtainedPrize) {
        ...
        var emptySlot = findEmptyInventorySlot(inventoryContainer);
...
function findEmptyInventorySlot(container) {
    var slots = container.getElementsByClassName('inventory__slot');
